...
public class AdapterBeritaUniversitas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<DataItemBeritaUniverstas> listUniv;
    ...
    public AdapterBeritaUniversitas(Context ctx) {
        this.ctx = ctx;
    }

    public AdapterBeritaUniversitas(Context ctx, List<DataItemBeritaUniverstas> itemUniversitas) {
