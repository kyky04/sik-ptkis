...
public class AdapterTim extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterTim(Context ctx) {
        this.ctx = ctx;
    }

    public AdapterTim(Context ctx, List<DataItemTeam> dataItemTeamList) {
