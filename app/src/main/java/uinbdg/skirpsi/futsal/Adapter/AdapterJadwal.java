...
public class AdapterJadwal extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<DataItemJadwal> dataItemTeamList;
    ...
    public AdapterJadwal(Context ctx) {
        this.ctx = ctx;
    }

    public AdapterJadwal(Context ctx, List<DataItemJadwal> dataItemTeamList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tim_jadwal, parent, false);
