...
import uinbdg.skirpsi.futsal.Fragment.SampleFragment;
...
//                                startActivity(new Intent(DrawerActivity.this,GridMenuActivity.class));
                                ...
                                CommonUtil.displayFragment(DrawerActivity.this,R.id._container, SampleFragment.newInstance("Sub Menu 1","Desc"),"TAG");
                            }else if (drawerItem.getIdentifier() == 22) {
                                CommonUtil.displayFragment(DrawerActivity.this,R.id._container, SampleFragment.newInstance("Sub Menu 2","Desc"),"TAG");
                            }
