...
import uinbdg.skirpsi.futsal.Adapter.AdapterKlinik;
import uinbdg.skirpsi.futsal.R;

/**
 * A simple {@link Fragment} subclass.
 */
public class ProviderKlinikFragment extends Fragment {

    @BindView(R.id.recycler_view_rs)
    RecyclerView recyclerViewRs;
    Unbinder unbinder;

    public ProviderKlinikFragment() {
    ...
    recyclerViewRs.setAdapter(new AdapterKlinik(getActivity()));
