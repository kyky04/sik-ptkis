...
import uinbdg.skirpsi.futsal.Adapter.AdapterDokter;
import uinbdg.skirpsi.futsal.R;

/**
 * A simple {@link Fragment} subclass.
 */
public class ProviderDokterFragment extends Fragment {

    @BindView(R.id.recycler_view_rs)
    RecyclerView recyclerViewRs;
    Unbinder unbinder;

    public ProviderDokterFragment() {
    ...
    recyclerViewRs.setAdapter(new AdapterDokter(getActivity()));
